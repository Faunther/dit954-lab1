...
public class Volvo240System <T extends Volvo240> extends CarSystem<T> {
    ArrayList<CarBrandWorkshop<T>> m_workshops = new ArrayList<>();
    ...
    public void onMoveTickEvent() {
        ...
        for (T car : m_cars) {
            ...
            for (CarBrandWorkshop<T> workshop : m_workshops) {
                ...
                Rectangle wr = new Rectangle(volvoWorkshopPoint, workshopSize);
                if (cr.intersects(wr)) {
